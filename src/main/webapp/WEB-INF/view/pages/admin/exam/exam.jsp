            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a onclick="add();" class="btn btn-primary btn-xs" permission="/admin/exam/saveAndUpdate">新建评价方案</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content col-md-11 modal-new-dialog">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal-title">添加评价方案</h4>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#entityBtnAdd").click(function () {
            ...
            form.find("input[name='purpose']").val("0");
    ...
    add = function () {
        qingkong();
        //问卷
        formSelect("paperId", "paper/getSelectList", {status:1,purpose:0})
        //学年
        formSelect("studyYearId", "bms/studyYear/getList", {})
        //评分标准
        formSelect("standardId", "standard/getSelectList", {status:1,purpose:0})
        $("#modal-title").html("新建评价方案");
        $('#addModal').modal('show');
